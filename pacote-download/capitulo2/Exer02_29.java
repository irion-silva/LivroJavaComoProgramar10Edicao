...
representar letras maiúsculas, minúsculas e uma variedade considerável de 
símbolos especiais. Cada caractere tem uma representação correspondente de 
inteiro. O conjunto de caracteres que um computador utiliza com as respectivas 
representações na forma de inteiro desses caracteres é chamado de conjunto de 
...
Você pode determinar o equivalente em inteiro de um caractere precedendo-o com 
(int), como em(int) 'A'
Um operador dessa forma é chamado operador de coerção. (Você aprenderá sobre os 
...
maiúsculas, minúsculas, dígitos e símbolos especiais. Mostre os equivalentes 
inteiros do seguinte: A B C a b c
...
public class Exer02_29 {
    ...
    public static void main(String[] args) {
        System.out.println("-----VALOR INTEIRO DE UM CARACTERE-----");
        /*System.out.printf("The character %c has the value %d%n", 'A', ((int) 'A'));*/
        System.out.printf("The character %c has the value %d%n", 'A', ((int) 'A'));
